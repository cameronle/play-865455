...
- 将 Flappy Wings 重做为原创卡通涂鸦版 Birdie Post：背邮包的小鸟、云朵障碍、手绘天空和移动端单键扑翼。
- 将 Bubble Shooter 重做为原创卡通涂鸦版 Bubble Garden：花朵泡泡、种子花园、彩色匹配和移动端拖拽瞄准。
- 将 Snake 重做为原创卡通涂鸦版 Worm & Apple：毛毛虫、苹果、浆果、花园方格纸和移动端方向键。
- 将 Sky Hopper 重做为原创卡通涂鸦版 Doodle Hop!，加入方格纸天空、手绘角色、云朵、太阳、星星和五种平台的 Canvas 表现。
- 三款新改造游戏和 Doodle Hop 均保留原有核心规则、本地最高分、暂停/重开、AUTO/LIGHT/DARK 主题和离线可运行的 Canvas/SVG 素材。
