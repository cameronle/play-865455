...
- [2048](./2048/) — 自维护的简约 2048 数字合并游戏，支持键盘、移动端滑动、方向按钮、本地最高分和浅深主题。
...
以上 27 款小游戏均由本仓库自行维护；游戏名称仅用于描述对应的经典玩法。

## 更新记录

### 2026-09-08

- 扩展 Melon Lab 水果合成路线至 11 层，新增 PEAR、PINEAPPLE、DRAGONFRUIT、PAPAYA 独立图形。
- 将前 6 层纳入加权掉落池，并让危险线随投放次数分阶段上移，保留半流体手感与双西瓜清除规则。
- Melon Lab 改为本局内循序解锁：开局经典 7 层，达到阶段分数和最低投放次数后依次扩展至 9 层、11 层，重开后恢复 7 层。
- 将合成路线图标改为按水果形状、切面、叶冠和籽粒区分，避免只靠颜色造成图形重复。

### 2026-09-05

- 新增 Mushroom Trail（蘑菇勇者）：原创马里奥风格平台跳跃冒险，包含三段手工关卡、金币、问号砖块、弹跳虫、移动平台、强化道具、检查点、终点旗帜和移动端三键操作。
