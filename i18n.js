  ...
  const DICT = {
    zh: {
      ...
      games: {
        ...
        "sokoban": {"name":"推箱子","desc":"规划移动路线，将所有箱子推入指定目标。"},
        "asteroids": {"name":"小行星","desc":"惯性漂移、转向射击，粉碎漫天碎石。"},
        "crosswalk": {"name":"过马路","desc":"观察车流节奏与红绿灯，安全穿越车道。"},
        "simon": {"name":"西蒙记忆","desc":"记忆声光序列并准确复现，挑战大脑极限。"},
        ...
        "sky-hopper": {"name":"空中跳跃","desc":"借助移动、弹簧等多种平台不断向上跃升。"},
    ...
    en: {
      ...
      games: {
        ...
        "sokoban": {"name":"SOKOBAN","desc":"Push every crate onto its target."},
        "asteroids": {"name":"ASTEROIDS","desc":"Drift, turn, fire, and clear the field."},
        "crosswalk": {"name":"CROSSWALK","desc":"Read the traffic and reach the far side."},
        "simon": {"name":"SIMON","desc":"Watch the sequence. Repeat it exactly."},
        ...
        "sky-hopper": {"name":"SKY HOPPER","desc":"Bounce higher across a shifting field of platforms."},
